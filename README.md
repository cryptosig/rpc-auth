...
@peerplaysio/rpc-auth
=================

JSONRPC 2.0 authentication with peerplays authorities
...
Request signing for [JSON-RPC 2.0](http://www.jsonrpc.org/specification) implemented using [peerplays](https://peerplays.io) authorities.
...
Requests are signed with peerplays keys belonging to the sender.
...
# Signing constant K (sha256('peerplays_jsonrpc_auth'))
...
### Signature validation
  ...
  1. `request['params']['__signed']['account']` must be a valid peerplays blockchain account
