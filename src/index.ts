/**
 * @file JSONRPC 2.0 request authentication with peerplays authorities.
 * @authors Cryptosig <https://github.com/cryptosig>,Johan Nordberg <johan@steemit.com>
 */

import {hexify, PrivateKey} from '@peerplaysio/libcrypto'
import {createHash, randomBytes} from 'crypto'

/**
 * Signing constant used to reserve opcode space and prevent cross-protocol attacks.
 * Output of `sha256('peerplays_jsonrpc_auth')`.
 */
...
export interface SignedJsonRpcRequest extends JsonRpcRequest {
    params: {
        __signed: {
            ...
            timestamp: string
            /** Signers Peerplays account name */
            account: string
 ...
 * @param account    Peerplays account name that is the signer.
 ...
 *
 * Responsible for:
 *   1. Account must be a valid Peerplays blockchain account
